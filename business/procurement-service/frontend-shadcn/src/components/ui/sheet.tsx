    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'inset-y-0 end-0 h-full w-3/4 border-s data-[state=closed]:slide-out-to-end data-[state=open]:slide-in-from-end sm:max-w-sm pe-0',
          side === 'left' &&
            'inset-y-0 start-0 h-full w-3/4 border-e data-[state=closed]:slide-out-to-start data-[state=open]:slide-in-from-start sm:max-w-sm ps-0',
          side === 'top' &&
        ...
        {...props}
      >
        <div className={cn('flex flex-col h-full', side === 'right' && 'ps-6 pe-4', side === 'left' && 'ps-4 pe-6')}>
          {children}
        </div>
