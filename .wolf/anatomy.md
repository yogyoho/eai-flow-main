...
> Auto-maintained by OpenWolf. Last scanned: 2026-07-26T15:20:23.333Z
...
- `DocAIAgentPanel.tsx` — Build the system prompt — format depends on mode. (~8428 tok)
- `DocumentManagement.tsx` — Windows 风格黄色文件夹图标（资源管理器样式） (~25031 tok)
