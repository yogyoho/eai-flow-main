...
- `App.vue` — Vue: setup (~311 tok)

## ../../aiproj/Pisuan-Know/web/src/assets/

- `theme.js` — https://www.antdv.com/docs/vue/customize-theme-cn (~144 tok)

## ../../aiproj/Pisuan-Know/web/src/assets/css/

- `base.css` — Styles: 89 vars (~984 tok)

## ../../aiproj/Pisuan-Know/web/src/components/dashboard/

- `CallStatsComponent.vue` — Vue: setup (~2487 tok)

## ../../aiproj/Pisuan-Know/web/src/utils/
...
- `_dump_msgs.py` — unwrap, render_content (~937 tok)
- `_extract_thread.py` (~475 tok)
- `_load_state.py` — dump_msgs, main_sync (~639 tok)
- `.cursorrules` (~467 tok)
- `.dockerignore` — Docker ignore rules (~191 tok)
- `.gitattributes` — Git attributes (~194 tok)
- `.gitignore` — Git ignore rules (~550 tok)
- `.mcp.json` (~84 tok)
...
- `Makefile` — DeerFlow - Unified Development Environment (~2530 tok)
- `manage.sh` — EAI Flow Docker Management Script (~752 tok)
- `pr_body.txt` — # Summary (~93 tok)
- `README_zh.md` — 🦌 DeerFlow - 2.0 (~4785 tok)
- `README.md` — Project documentation (~9610 tok)
- `SECURITY.md` — Security Policy (~99 tok)
- `test_fixes.py` — log, login, fetch_json (~3379 tok)
- `test_tabs.py` — Quick browser test of all 7 tabs in the project workspace. (~1228 tok)
...
- `SKILL.md` — DeerFlow Smoke Test Skill (~2338 tok)

## .agent/skills/smoke-test/references/

- `SOP.md` — DeerFlow Smoke Test Standard Operating Procedure (SOP) (~2465 tok)
- `troubleshooting.md` — Troubleshooting Guide (~2767 tok)

## .agent/skills/smoke-test/scripts/

- `check_docker.sh` (~586 tok)
- `check_local_env.sh` (~690 tok)
- `deploy_docker.sh` (~495 tok)
- `deploy_local.sh` (~440 tok)
- `frontend_check.sh` (~570 tok)
- `health_check.sh` (~885 tok)
- `pull_code.sh` (~353 tok)

## .agent/skills/smoke-test/templates/

- `report.docker.template.md` — DeerFlow Smoke Test Report (~1146 tok)
- `report.local.template.md` — DeerFlow Smoke Test Report (~1179 tok)

## .claude/

- `settings.json` (~564 tok)
- `settings.local.json` (~2980 tok)
...
- `debug-issue.md` — Debug Issue (~278 tok)
- `explore-codebase.md` — Explore Codebase (~308 tok)
- `refactor-safely.md` — Refactor Safely (~306 tok)
- `review-changes.md` — Review Changes (~273 tok)
...
- `copilot-instructions.md` — Copilot Onboarding Instructions for DeerFlow (~1722 tok)

## .github/ISSUE_TEMPLATE/

- `runtime-information.yml` (~823 tok)
...
- `code-review-graph.md` — MCP Tools: code-review-graph (~438 tok)
...
## .superpowers/brainstorm/1021-1779671997/content/

- `approaches.html` (~1391 tok)
- `design-section1.html` — ProjectMembership: useProjectPermissions (~1419 tok)
- `design-section2-workspace.html` — Declares TabConfig (~2997 tok)
...
- `current-vs-compact.html` (~1491 tok)
- `qianwen-style-design.html` (~3412 tok)
...
- `permission_routers.py` — Permission API endpoints — registry, current user permissions, role config. (~883 tok)
- `registry.py` — Permission registry - loads permissions.yaml, serves permission metadata. (~2393 tok)

## .worktrees/abac-3level/backend/tests/

- `test_permission_registry.py` — TestPermissionRegistry: test_loads_all_modules_from_yaml, test_get_permission_by_id, test_list_all_p (~2544 tok)

## .worktrees/abac-3level/frontend/src/app/workspace/

- `workspace-content.tsx` — EAI-CUSTOM: nav-level permission gating for sidebar and settings (~387 tok)

## .worktrees/abac-3level/frontend/src/components/workspace/

- `workspace-nav-chat-list.tsx` — WorkspaceNavChatList (~1140 tok)
- `workspace-nav-menu.tsx` — NavMenuButtonContent (~1145 tok)

## .worktrees/abac-3level/frontend/src/core/permissions/

- `PermissionProvider.tsx` — PermissionContext (~570 tok)
- `usePermission.ts` — Exports PermissionState, usePermission (~516 tok)

## .worktrees/abac-3level/frontend/src/extensions/app-center/components/

- `AppGrid.tsx` — 业务域首次出现顺序（用于 accent 确定性分配） (~541 tok)

## .worktrees/abac-permissions/.wolf/

- `anatomy.md` — anatomy.md (~33855 tok)
- `buglog.json` (~80445 tok)
- `cerebrum.md` — Cerebrum (~17237 tok)
- `memory.md` — Memory (~230139 tok)

## .worktrees/abac-permissions/backend/app/extensions/auth/

- `engine.py` — Unified ABAC-lite permission engine. (~1595 tok)
- `identity.py` — Identity provider - resolves a user to an AttributeSet for ABAC evaluation. (~1394 tok)
- `middleware.py` — Authentication middleware for extensions module. (~3274 tok)
- `registry.py` — Permission registry - loads permissions.yaml, serves permission metadata. (~1715 tok)

## .worktrees/abac-permissions/backend/tests/

- `test_identity_provider.py` — Tests for AttributeSet and IdentityProvider. (~3244 tok)
- `test_permission_engine.py` — TestUnifiedPermissionEngine: identity, test_star_wildcard_grants_all, test_exact_permission_match, t (~2046 tok)
- `test_permission_registry.py` — TestPermissionRegistry: test_loads_all_modules_from_yaml, test_get_permission_by_id, test_list_all_p (~1230 tok)

## .worktrees/abac-permissions/config/

- `permissions.yaml` — permissions.yaml — 模块权限声明 + 角色默认映射 + seed 策略 (~1848 tok)

## .worktrees/abac-phase2/.wolf/

- `anatomy.md` — anatomy.md (~33863 tok)
- `memory.md` — Memory (~230285 tok)

## .worktrees/abac-phase2/backend/app/extensions/

- `database.py` — Database connection and session management for extensions module. (~19559 tok)

## .worktrees/abac-phase2/backend/app/extensions/auth/

- `cache.py` — Request-scoped caching for permission engine and identity. (~340 tok)
- `datascope.py` — Data scope engine - resolves role data_scopes to FilterRules. (~703 tok)
- `engine.py` — Unified ABAC-lite permission engine. (~1932 tok)
- `middleware.py` — Authentication middleware for extensions module. (~3940 tok)
- `models.py` — ABAC policy model. (~274 tok)
- `policy_routers.py` — ABAC policy CRUD endpoints. (~939 tok)

## .worktrees/abac-phase2/backend/app/extensions/knowledge/

- `routers.py` — Knowledge base routers for extensions module. (~5250 tok)

## .worktrees/abac-phase2/backend/app/gateway/

- `app.py` — lifespan (~6792 tok)

## .worktrees/abac-phase2/backend/tests/

- `test_datascope.py` — TestDataScopeEngine: test_get_data_scope_returns_filter_rule, test_unknown_resource_returns_none_all (~996 tok)
- `test_permission_engine.py` — TestUnifiedPermissionEngine: identity, test_star_wildcard_grants_all, test_exact_permission_match, t (~2866 tok)
- `test_policy_crud.py` — Tests for Policy model and engine integration. (~161 tok)

## .worktrees/abac-phase3/.wolf/

- `anatomy.md` — anatomy.md (~33822 tok)
- `memory.md` — Memory (~230149 tok)

## .worktrees/abac-phase3/backend/app/extensions/auth/

- `permission_routers.py` — Permission API endpoints — registry, current user permissions, role config. (~726 tok)

## .worktrees/abac-phase3/backend/app/gateway/

- `app.py` — lifespan (~6842 tok)

## .worktrees/abac-phase3/frontend/src/app/admin/

- `layout.tsx` — Check if the current user has admin privileges. (~917 tok)

## .worktrees/abac-phase3/frontend/src/app/admin/roles/

- `page.tsx` — PERMISSION_CATEGORIES (~19025 tok)

## .worktrees/abac-phase3/frontend/src/app/admin/users/

- `page.tsx` — PAGE_SIZE (~10900 tok)

## .worktrees/abac-phase3/frontend/src/app/knowledge/

- `page.tsx` — formatDate (~23449 tok)

## .worktrees/abac-phase3/frontend/src/core/permissions/

- `index.ts` (~47 tok)
- `PermissionProvider.tsx` — PermissionContext (~544 tok)
- `usePermission.ts` — Exports PermissionState, usePermission (~402 tok)

## .worktrees/abac-phase3/frontend/src/extensions/

- `types.ts` — Exports LoginRequest, LoginResponse, CurrentUser, User + 59 more (~3300 tok)

## .worktrees/abac-phase3/frontend/src/extensions/api/

- `index.ts` — API routes: GET (2 endpoints) (~12513 tok)

## .worktrees/abac-tree/backend/app/extensions/auth/

- `permission_routers.py` — Permission API endpoints — registry, current user permissions, role config. (~1074 tok)
- `registry.py` — Permission registry - loads permissions.yaml, serves permission metadata. (~2653 tok)

## .worktrees/abac-tree/config/

- `permissions.yaml` — permissions.yaml — 三级权限模型：导航 → 页面 → 操作 (~3122 tok)

## .worktrees/abac-tree/frontend/src/app/admin/roles/

- `page.tsx` — Check whether any module in the registry has the pages array (v3 tree format). (~22192 tok)

## .worktrees/abac-tree/frontend/src/extensions/

- `types.ts` — 三级权限树中的页面节点（v3），包含嵌套的操作列表 (~3373 tok)
...
- `ai-ai-agent-ai-ai-ai-ai-greedy-diffie.md` — Function Calling 替代 MCP — 实施方案 (~472 tok)
...
- `cheerful-munching-canyon-agent-a80aadd434cbefd8c.md` — Plan: Task 1 — FilterRule `overlap` operator (数组重叠) (~1160 tok)
- `concurrent-mixing-pillow.md` — 恢复 DynamicContextMiddleware 的 project-context 读取(bug-697) (~1402 tok)
- `concurrent-roaming-pie.md` — Plan: 修复 7月16后引入的 streamdown preprocess 卡顿回归 (~952 tok)
- `cosmic-soaring-leaf.md` — Fix: gateway 502 after install — generate-config.sh destroys the full config.yaml (~1702 tok)
...
- `linear-baking-adleman.md` — 100 contracts feasibility analysis (~499 tok)
...
- `typed-cooking-quilt.md` — Plan: EditorTab 改造 — 横向章节栏 → 左侧树形大纲 (~803 tok)
- `velvet-wondering-pike.md` — Fix: DocMgr AI Assistant 404 "Thread not found" (~334 tok)
- `velvety-waddling-hopcroft.md` — Plan: Add `cwd` support to MCP server config (方案3) (~916 tok)
- `vivid-wishing-hippo.md` — Plan: 完善协同编辑器版本历史面板 (~179 tok)
...
- `eai-custom-annotation-convention.md` (~204 tok)
- `eai-custom-annotation-rule.md` — 补充：harness 核心代码改动的强差分规范（2026-08-02 用户确认） (~496 tok)
- `fire-protection-extract-staged-redesign.md` (~405 tok)
- `frontend-deps-need-image-rebuild.md` — Declares errors (~922 tok)
- `frontend-tests-not-bindmounted.md` — ` and the container typecheck seems to ignore it, check `docker inspect deer-flow-frontend` mounts — (~489 tok)
...
- `debug_env_import.py` (~149 tok)
- `debug_get_db.py` — main (~128 tok)
- `debug_sqla.py` — Debug SQLAlchemy connection. (~178 tok)
- `debug_url.py` — Debug the actual connection URL. (~184 tok)
- `detailed_settings_analysis.py` (~1416 tok)
...
- `test_debug.py` — Debug: inspect the settings page DOM to find the GroupedModelSelect components. (~585 tok)
- `test_debug2.py` — Debug: inspect the GroupedModelSelect wrapper divs directly. (~482 tok)
- `test_debug3.py` — Debug: check if GroupedModelSelect is rendering by inspecting raw HTML. (~623 tok)
- `test_direct_gateway.py` — Test directly to gateway (~102 tok)
- `test_docker_network.py` — Test direct to gateway via docker network (~121 tok)
- `test_engine.py` — Test file (~161 tok)
- `test_fastapi_request.py` — Test script that simulates FastAPI request with Depends(get_db). (~466 tok)
- `test_final.py` — Final test: verify GroupedModelSelect renders on settings page. (~1329 tok)
- `test_from_nginx.py` — Test directly from nginx container to gateway (~103 tok)
- `test_full_import.py` — Test connection after full module import. (~312 tok)
- `test_getdb.py` — Tests: get_db (~226 tok)
- `test_in_uvicorn_context.py` — Test network in uvicorn context. (~476 tok)
- `test_ip_vs_hostname.py` — Test SQLAlchemy with IP address instead of hostname. (~408 tok)
- `test_login_api.py` — Test file (~84 tok)
- `test_login.py` — Tests: login (~222 tok)
- `test_model_validation_debug.py` — Fix Unicode encoding for Windows (~2484 tok)
- `test_model_validation_final.py` — Fix Unicode encoding for Windows (~3237 tok)
- `test_model_validation_v2.py` — Fix Unicode encoding for Windows (~2754 tok)
- `test_model_validation_v3.py` — Fix Unicode encoding for Windows (~3008 tok)
- `test_model_validation.py` — Fix Unicode encoding for Windows (~2002 tok)
- `test_pg.py` — Test file (~40 tok)
- `test_settings_auth.py` — Test the settings page with full auth flow. (~1305 tok)
- `test_settings_v2.py` — Test the settings page with full auth flow. (~1680 tok)
- `test_settings.py` — Test the settings page with GroupedModelSelect components. (~1152 tok)
- `test_sqlalchemy_strategies.py` — Test SQLAlchemy with explicit asyncpg pool. (~610 tok)
- `test_uvicorn_env.py` — Tests: uvicorn_env (~326 tok)
- `test_uvloop.py` — Test script that simulates uvicorn worker process. (~328 tok)
- `test_validator_module.py` — Tests for validator module without FastAPI dependencies. (~1807 tok)
- `test_validator_simple.py` — Simple tests for validator module data models. (~1553 tok)
- `test_validator.py` — Tests for validator module using pytest fixtures. (~1644 tok)
- `TESTING_REPORT.md` — Model Validation End-to-End Testing Report (~1925 tok)
- `verify_settings.py` (~267 tok)
- `verify_validate_button.py` (~404 tok)

## _workspace_temp/.eai-flow/

- `checkpoints.db-shm` (~8739 tok)
- `checkpoints.db-wal` (~0 tok)

## _workspace_temp/.eai-flow/threads/c3adcb99-ba11-4c6e-b363-60f8ec7c620a/user-data/workspace/

- `仓库项目-消防设计专篇.md` — ××仓库项目消防设计专篇 (~1582 tok)
- `消防设计专篇.md` — 消防设计专篇 (~1588 tok)
- `check_apt.py` — Check if apt has it first (~495 tok)
- `check_docx.py` — Check if python-docx is available and attempt to install if not. (~150 tok)
- `check_env.py` (~229 tok)
- `check_pip.py` — Check what python and pip are available (~284 tok)
- `check_tools.py` (~149 tok)
- `check.py` — Debug: find the python being used (~197 tok)
- `convert_docx.py` (~123 tok)
- `convert_report.py` — Convert fire protection markdown report to Word document. (~192 tok)
- `convert.py` — Use libreoffice to extract text from both documents (~265 tok)
- `debug_env.py` — Let's first check what python version we have and test (~348 tok)
- `do_extract.py` — Extract all content from the fire protection report docx. (~255 tok)
- `extract_all.py` — Step 1: Install python-docx (~469 tok)
- `extract_both.py` — Extract .doc using catdoc and .docx directly (~328 tok)
- `extract_content.py` — Step 1: apt install (~194 tok)
- `extract_docs.py` (~596 tok)
- `extract_docx_raw.py` — Try to extract the docx file content using python's zipfile to at least see the XML (~525 tok)
- `extract_docx.py` — Simple extraction script - test with just docx first (~332 tok)
- `extract_docx2.py` — Try to extract content from the reference docx file using various methods (~426 tok)
- `extract_fire_report.py` — First check if python3-docx is already installed (~319 tok)
- `extract_raw.py` — Direct extraction from docx using zipfile (~106 tok)
- `extract_ref.py` — Try to install python-docx (~260 tok)
- `extract.py` — Extract docx content using python-docx (~149 tok)
- `final_extract.py` — Check if python-docx is already available (maybe from apt) (~398 tok)
- `fire_protection_report.md` — 某化工项目丙类仓库消防设计专篇 (~1501 tok)
- `fire_report.md` — 某化工仓库项目 消防设计专篇 (~2404 tok)
- `install_and_extract.py` — Install python-docx and extract content (~471 tok)
- `install_and_read.py` — Try multiple pip install approaches (~440 tok)
- `install_apt.py` — First check pip availability (~319 tok)
- `install_pip.py` — Try to install python-docx and then extract content (~309 tok)
- `pip_extract.py` — Extract fire report content - simpler approach (~448 tok)
- `quick_check.py` (~251 tok)
- `read_all.py` — Try pip install with --break-system-packages (~612 tok)
- `read_doc.py` (~191 tok)
- `read_docx.py` — Try to install python-docx and read the reference doc (~245 tok)
- `read_ref.py` — Install python-docx (~197 tok)
- `read_ref2.py` (~177 tok)
- `read_ref3.py` — Try pip install with --user flag (~215 tok)
- `run_conversion.py` — Convert the fire protection report markdown to docx. (~211 tok)
- `run_convert.py` (~138 tok)
- `run_convert.sh` (~71 tok)
- `run_do.py` — Try to install python3-docx via apt-get (~305 tok)
- `run_extract.py` — Install python-docx and extract content from the docx file. (~257 tok)
- `test_py3.py` — Try to extract content using python3-docx (~475 tok)
- `try.py` — Run apt install (~242 tok)

## andrej-karpathy-skills-main/

- `CLAUDE.md` — CLAUDE.md (~587 tok)
- `CURSOR.md` — Using this repo with Cursor (~488 tok)
- `EXAMPLES.md` — Examples (~3698 tok)
- `README.md` — Project documentation (~1541 tok)
- `README.zh.md` — 受 Karpathy 启发的 Claude Code 指南 (~764 tok)

## andrej-karpathy-skills-main/.claude-plugin/

- `marketplace.json` (~217 tok)
- `plugin.json` (~112 tok)

## andrej-karpathy-skills-main/.cursor/rules/

- `karpathy-guidelines.mdc` (~701 tok)

## andrej-karpathy-skills-main/skills/karpathy-guidelines/

- `SKILL.md` — Karpathy Guidelines (~627 tok)

## backend/

- `_verify_writing.py` — State machine (~343 tok)
...
- `test_lxml_perf.py` — Test lxml-based docx parsing performance. (~360 tok)
- `test_sync_e2e.py` — End-to-end test for the sync flow. (~1031 tok)
- `verify_routes.py` — Debug route paths in project router. (~76 tok)

## backend/.deer-flow/

- `checkpoints.db-shm` (~8739 tok)
- `checkpoints.db-wal` (~0 tok)
- `memory.json` (~1133 tok)

## backend/.deer-flow/data/

- `deerflow.db-shm` (~8739 tok)
- `deerflow.db-wal` (~0 tok)

## backend/.deer-flow/threads/bf4680b9-5ea2-4fa3-a732-4f6576c7e671/user-data/workspace/

- `convert.sh` (~74 tok)
- `fire_protection_report.md` — 辽阳石化100万吨/年乙烯装置新建项目消防设计专篇 (~5116 tok)

## backend/.deer-flow/users/6e058181-b5e7-495b-8307-35ff20dc4080/threads/415c3d7c-cb62-4468-bcff-4fd852a5da8b/user-data/outputs/

- `消防设计专篇.md` — 抚顺石化分公司40万吨/年高性能聚丙烯装置 消防设计专篇 (~3120 tok)

## backend/.deer-flow/users/6e058181-b5e7-495b-8307-35ff20dc4080/threads/415c3d7c-cb62-4468-bcff-4fd852a5da8b/user-data/workspace/
...
- `.langgraph_checkpoint.1.pckl` (~2 tok)
- `.langgraph_checkpoint.2.pckl` (~2 tok)
- `.langgraph_checkpoint.3.pckl` (~2 tok)
- `.langgraph_ops.pckl` (~2244 tok)
- `.langgraph_retry_counter.pckl` (~2 tok)
- `store.pckl` (~2 tok)
- `store.vectors.pckl` (~2 tok)
...
- `11844969678240109832` (~51 tok)
- `12917098456977056701` (~23 tok)
- `13527975452322748411` (~83 tok)
- `14240237225486965553` (~28 tok)
- `17668251748539650227` (~2141 tok)
- `1812392303413289134` (~1912 tok)
- `2973906558295936085` (~28 tok)
- `3212789355856019229` (~28 tok)
- `3425761166878515440` (~27 tok)
- `3789799744185107317` (~37 tok)
- `5334142182381614210` (~1498 tok)
- `5732794526751133529` (~26 tok)
- `6630951819968574894` (~87 tok)
- `7060056841951326610` (~37 tok)
- `8039901015762739716` (~38 tok)
- `8173241397888585431` (~36 tok)
- `8484248488679671400` (~26 tok)
- `8540600494026090501` (~37 tok)
...
- `_editable_impl_deerflow_harness.pth` (~12 tok)
...
- `google_auth_httplib2.py` — Transport adapter for httplib2. (~2902 tok)
- `hatch_build.py` — Build hook to conditionally vendor grpc_common into wheels. (~497 tok)
...
- `LICENSE` — Project license (~1029 tok)
- `logging.json` (~105 tok)
- `nest_asyncio.py` — Patch asyncio to allow nested event loops. (~2140 tok)
- `OleFileIO_PL.py` — -*- coding: latin-1 -*- (~386 tok)
- `openapi.json` (~58641 tok)
...
- `readline.py` — -*- coding: UTF-8 -*- (~762 tok)
...
## backend/.venv/Lib/site-packages/_argon2_cffi_bindings/

- `__init__.py` — SPDX-License-Identifier: MIT (~27 tok)
- `_ffi_build.py` — SPDX-License-Identifier: MIT (~1864 tok)
- `_ffi.pyd` (~16031 tok)

## backend/.venv/Lib/site-packages/_distutils_hack/

- `__init__.py` — don't import any costly modules (~1930 tok)
- `override.py` (~13 tok)

## backend/.venv/Lib/site-packages/_duckdb-stubs/

- `__init__.pyi` — Declares BinderException (~14708 tok)
- `_enums.pyi` — Declares CppEnum (~2017 tok)
- `_expression.pyi` — Declares Expression (~740 tok)
- `_func.pyi` — Declares FunctionNullHandling (~312 tok)
- `_sqltypes.pyi` — Declares DuckDBPyType (~643 tok)
- `_typing.pyi` — Declares NPProtocol (~2149 tok)
...
## backend/.venv/Lib/site-packages/acp/

- `__init__.py` (~1367 tok)
- `connection.py` — from: close, main_loop, add_observer, send_request + 1 more (~3039 tok)
- `core.py` — Compatibility re-exports for historical imports. (~950 tok)
- `exceptions.py` — RequestError: parse_error, invalid_request, method_not_found, invalid_params + 4 more (~443 tok)
- `helpers.py` — text_block, image_block, audio_block, resource_link_block + 21 more (~2294 tok)
- `interfaces.py` — Client: request_permission, session_update, write_text_file, read_text_file + 24 more (~2108 tok)
- `meta.py` — Schema ref: refs/tags/v0.11.2 (~312 tok)
- `py.typed` — Marker file for PEP 561 to indicate the package provides type hints. (~19 tok)
- `router.py` — from: handle, add_route, wrapper, route_request + 3 more (~1824 tok)
- `schema.py` — Schema ref: refs/tags/v0.11.2 (~44670 tok)
- `stdio.py` — _WritePipeProtocol: pause_writing, resume_writing, blocking_read, write + 9 more (~2034 tok)
- `telemetry.py` — span_context (~479 tok)
- `transports.py` — default_environment, spawn_stdio_transport (~1054 tok)
- `utils.py` — as: model_to_kwargs, serialize_params, normalize_result, ensure_dict + 17 more (~2683 tok)

## backend/.venv/Lib/site-packages/acp/agent/

- `__init__.py` (~23 tok)
- `connection.py` — class: listen, session_update, request_permission, read_text_file + 10 more (~2229 tok)
- `router.py` — API router (~1238 tok)

## backend/.venv/Lib/site-packages/acp/client/

- `__init__.py` (~24 tok)
- `connection.py` — class: initialize, new_session, load_session, list_sessions + 13 more (~2850 tok)
- `router.py` — API router (~825 tok)

## backend/.venv/Lib/site-packages/acp/contrib/

- `__init__.py` (~260 tok)
- `permissions.py` — PermissionBrokerError: default_permission_options, request_for (~972 tok)
- `session_state.py` — SessionNotificationMismatchError: apply_start, apply_progress, snapshot, reset + 4 more (~2864 tok)
- `tool_calls.py` — _MissingToolCallTitleError: to_view, to_tool_call_model, to_start_model, update + 7 more (~2523 tok)

## backend/.venv/Lib/site-packages/acp/task/

- `__init__.py` — Declares from (~292 tok)
- `dispatcher.py` — MessageDispatcher: start, stop, start, stop + 2 more (~859 tok)
- `queue.py` — MessageQueue: publish, close, task_done, join + 4 more (~495 tok)
- `sender.py` — from: send, close (~621 tok)
- `state.py` — from: register_outgoing, resolve_outgoing, reject_outgoing, reject_all_outgoing + 10 more (~770 tok)
- `supervisor.py` — TaskSupervisor: add_error_handler, create, shutdown (~766 tok)

## backend/.venv/Lib/site-packages/adbc_driver_duckdb/

- `__init__.py` — Low-level ADBC bindings for the DuckDB driver. (~535 tok)
- `dbapi.py` — DBAPI 2.0-compatible facade for the ADBC DuckDB driver. (~1014 tok)

## backend/.venv/Lib/site-packages/adodbapi/
...
## backend/.venv/Lib/site-packages/adodbapi/examples/
...
## backend/.venv/Lib/site-packages/adodbapi/test/
...
## backend/.venv/Lib/site-packages/agent_client_protocol-0.9.0.dist-info/

- `entry_points.txt` (~9 tok)
- `INSTALLER` (~1 tok)
- `METADATA` — Declares analysis (~1526 tok)
- `RECORD` (~780 tok)
- `REQUESTED` (~0 tok)
- `WHEEL` (~24 tok)

## backend/.venv/Lib/site-packages/agent_client_protocol-0.9.0.dist-info/licenses/

- `LICENSE` — Project license (~3029 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~6087 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~5343 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/auth/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~1458 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~1984 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/bash/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~6725 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~10811 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~640 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~3724 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~6754 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser/types/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~645 tok)
- `action.py` — This file was auto-generated by Fern from our API Definition. (~2178 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_captcha/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~1453 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~2336 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_cookies/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~1974 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~3358 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_network/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~3905 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~7615 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_page/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~330 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~17208 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~33952 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_page/types/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~364 tok)
- `navigate_request_wait_until.py` — This file was auto-generated by Fern from our API Definition. (~58 tok)
- `record_request_action.py` — This file was auto-generated by Fern from our API Definition. (~57 tok)
- `type.py` — This file was auto-generated by Fern from our API Definition. (~69 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_state/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~1355 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~2542 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/browser_tabs/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~2265 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~4272 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/code/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~2086 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~2964 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/core/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~1018 tok)
- `api_error.py` — This file was auto-generated by Fern from our API Definition. (~176 tok)
- `client_wrapper.py` — This file was auto-generated by Fern from our API Definition. (~589 tok)
- `datetime_utils.py` — This file was auto-generated by Fern from our API Definition. (~300 tok)
- `file.py` — This file was auto-generated by Fern from our API Definition. (~761 tok)
- `force_multipart.py` — This file was auto-generated by Fern from our API Definition. (~137 tok)
- `http_client.py` — This file was auto-generated by Fern from our API Definition. (~6062 tok)
- `http_response.py` — This file was auto-generated by Fern from our API Definition. (~380 tok)
- `jsonable_encoder.py` — This file was auto-generated by Fern from our API Definition. (~1045 tok)
- `pydantic_utilities.py` — This file was auto-generated by Fern from our API Definition. (~3095 tok)
- `query_encoder.py` — This file was auto-generated by Fern from our API Definition. (~613 tok)
- `remove_none_from_dict.py` — This file was auto-generated by Fern from our API Definition. (~98 tok)
- `request_options.py` — This file was auto-generated by Fern from our API Definition. (~481 tok)
- `serialization.py` — This file was auto-generated by Fern from our API Definition. (~2806 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/display/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~285 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~1652 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~2223 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/display/types/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~290 tok)
- `display_action.py` — This file was auto-generated by Fern from our API Definition. (~47 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/errors/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~306 tok)
- `unprocessable_entity_error.py` — This file was auto-generated by Fern from our API Definition. (~115 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/file/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~354 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~17392 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~28598 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/file/types/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~407 tok)
- `command.py` — This file was auto-generated by Fern from our API Definition. (~54 tok)
- `file_watch_wait_request_event_types_item.py` — This file was auto-generated by Fern from our API Definition. (~61 tok)
- `str_replace_editor_request_replace_mode.py` — This file was auto-generated by Fern from our API Definition. (~52 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/jupyter/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~4352 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~7134 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/mcp/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~2543 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~3929 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/nodejs/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~6151 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~9904 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/proxy/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~6045 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~10948 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/sandbox/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~3738 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~6370 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/shell/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~9546 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~15848 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/skills/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~25 tok)
- `client.py` — This file was auto-generated by Fern from our API Definition. (~3014 tok)
- `raw_client.py` — This file was auto-generated by Fern from our API Definition. (~5657 tok)

## backend/.venv/Lib/site-packages/agent_sandbox/types/

- `__init__.py` — This file was auto-generated by Fern from our API Definition. (~7442 tok)
- `action_data.py` — This file was auto-generated by Fern from our API Definition. (~181 tok)
- `action_response.py` — This file was auto-generated by Fern from our API Definition. (~392 tok)
- `active_sessions_result.py` — This file was auto-generated by Fern from our API Definition. (~204 tok)
- `active_shell_sessions_result.py` — This file was auto-generated by Fern from our API Definition. (~212 tok)
- `annotations_audience_item.py` — This file was auto-generated by Fern from our API Definition. (~48 tok)
- `annotations.py` — This file was auto-generated by Fern from our API Definition. (~196 tok)
- `audio_content.py` — This file was auto-generated by Fern from our API Definition. (~276 tok)
- `available_tool.py` — This file was auto-generated by Fern from our API Definition. (~221 tok)
- `bash_command_info.py` — This file was auto-generated by Fern from our API Definition. (~284 tok)
- `bash_command_status.py` — This file was auto-generated by Fern from our API Definition. (~64 tok)
- `bash_exec_result.py` — This file was auto-generated by Fern from our API Definition. (~442 tok)
- `bash_output_result.py` — This file was auto-generated by Fern from our API Definition. (~387 tok)
- `bash_session_info.py` — This file was auto-generated by Fern from our API Definition. (~374 tok)
- `blob_resource_contents.py` — This file was auto-generated by Fern from our API Definition. (~264 tok)
- `browser_info_result.py` — This file was auto-generated by Fern from our API Definition. (~359 tok)
- `browser_viewport.py` — This file was auto-generated by Fern from our API Definition. (~186 tok)
- `button.py` — This file was auto-generated by Fern from our API Definition. (~45 tok)
- `call_tool_result.py` — This file was auto-generated by Fern from our API Definition. (~357 tok)
- `captcha_wait_result.py` — This file was auto-generated by Fern from our API Definition. (~152 tok)
- `check_request.py` — This file was auto-generated by Fern from our API Definition. (~150 tok)
- `click_action.py` — This file was auto-generated by Fern from our API Definition. (~198 tok)
- `code_execute_response.py` — This file was auto-generated by Fern from our API Definition. (~484 tok)
- `code_info_response.py` — This file was auto-generated by Fern from our API Definition. (~211 tok)
- `code_language_info.py` — This file was auto-generated by Fern from our API Definition. (~380 tok)
- `command_status.py` — This file was auto-generated by Fern from our API Definition. (~56 tok)
- `console_record.py` — This file was auto-generated by Fern from our API Definition. (~267 tok)
- `dependency_command_result.py` — This file was auto-generated by Fern from our API Definition. (~266 tok)
- `display_record_result.py` — This file was auto-generated by Fern from our API Definition. (~199 tok)
- `double_click_action.py` — This file was auto-generated by Fern from our API Definition. (~167 tok)
- `drag_rel_action.py` — This file was auto-generated by Fern from our API Definition. (~206 tok)
- `drag_to_action.py` — This file was auto-generated by Fern from our API Definition. (~191 tok)
- `embedded_resource.py` — This file was auto-generated by Fern from our API Definition. (~310 tok)
- `file_content_encoding.py` — This file was auto-generated by Fern from our API Definition. (~49 tok)
- `file_find_result.py` — This file was auto-generated by Fern from our API Definition. (~213 tok)
- `file_glob_result.py` — This file was auto-generated by Fern from our API Definition. (~315 tok)
- `file_grep_result.py` — This file was auto-generated by Fern from our API Definition. (~381 tok)
- `file_info.py` — This file was auto-generated by Fern from our API Definition. (~342 tok)
- `file_list_result.py` — This file was auto-generated by Fern from our API Definition. (~320 tok)
- `file_read_result.py` — This file was auto-generated by Fern from our API Definition. (~198 tok)
- `file_replace_result.py` — This file was auto-generated by Fern from our API Definition. (~217 tok)
- `file_search_result.py` — This file was auto-generated by Fern from our API Definition. (~255 tok)
- `file_upload_result.py` — This file was auto-generated by Fern from our API Definition. (~233 tok)
- `file_write_result.py` — This file was auto-generated by Fern from our API Definition. (~212 tok)
- `glob_file_info.py` — This file was auto-generated by Fern from our API Definition. (~293 tok)
- `grep_match.py` — This file was auto-generated by Fern from our API Definition. (~302 tok)
- `hotkey_action.py` — This file was auto-generated by Fern from our API Definition. (~152 tok)
- `http_validation_error.py` — This file was auto-generated by Fern from our API Definition. (~178 tok)
- `icon.py` — This file was auto-generated by Fern from our API Definition. (~229 tok)
- `image_content.py` — This file was auto-generated by Fern from our API Definition. (~276 tok)
- `jupyter_create_session_response.py` — This file was auto-generated by Fern from our API Definition. (~253 tok)
- `jupyter_execute_response.py` — This file was auto-generated by Fern from our API Definition. (~388 tok)
- `jupyter_info_response.py` — This file was auto-generated by Fern from our API Definition. (~353 tok)
- `jupyter_output.py` — This file was auto-generated by Fern from our API Definition. (~495 tok)
- `key_down_action.py` — This file was auto-generated by Fern from our API Definition. (~149 tok)
- `key_up_action.py` — This file was auto-generated by Fern from our API Definition. (~148 tok)
- `language.py` — This file was auto-generated by Fern from our API Definition. (~45 tok)
- `list_tools_result.py` — This file was auto-generated by Fern from our API Definition. (~280 tok)
- `mode.py` — This file was auto-generated by Fern from our API Definition. (~42 tok)
- `mouse_down_action.py` — This file was auto-generated by Fern from our API Definition. (~166 tok)
...
- `routers.py` — App-center API router — DB-persisted app catalog. (~1439 tok)
...
- `policy_routers.py` — ABAC policy CRUD endpoints. (~1617 tok)
- `registry.py` — Permission registry - loads permissions.yaml, serves permission metadata. (~3855 tok)
- `routers.py` — Authentication routers for extensions module. (~3154 tok)
- `sso.py` — EAI SSO — 通用 OIDC 第三登录门面（发起 + 回调）。 (~1961 tok)
- `unified_permissions.py` — Unified permission checking — single entry point for all project RBAC. (~3105 tok)
...
- `__init__.py` (~0 tok)
- `reminder_service.py` — Deadline-based reminder trigger service. (~2556 tok)
- `routers.py` — Dashboard API routers — task console, projects, stats, calendar, notifications. (~1418 tok)
- `schemas.py` — Pydantic schemas for dashboard API. (~1190 tok)
- `service.py` — Dashboard service — aggregates tasks, projects, stats, and calendar events for a user. (~6104 tok)
- `todo_aggregator.py` — Cross-context todo aggregation — no new table, pure query views. (~1538 tok)
...
- `__init__.py` — AI Document management module. (~105 tok)
- `collab_ai_chat.py` — AI chat endpoint for collaborative editor. (~4110 tok)
- `collab_models.py` — SQLAlchemy models for collaborative editing tables. (~1082 tok)
- `collab_routers.py` — Routers for collaborative editing: comments and versions. (~2968 tok)
...
- `editor_mcp.py` — Document Editor MCP Server — editor manipulation tools for docmgr agent. (~4070 tok)
...
- `routers.py` — FastAPI routers for law management. (~4429 tok)
- `schemas.py` — Pydantic schemas for law management. (~1760 tok)
- `service.py` — Business logic for law management. (~8432 tok)
...
- `__init__.py` — Review Context — review assignments, judgments, gating, rollback. (~21 tok)
- `gate.py` — Review gate — waits for all assigned reviewers before deciding outcome. (~695 tok)
- `models.py` — Review Context ORM models — unified replacement for PhaseReview + ApprovalWorkflow. (~536 tok)
- `rollback.py` — Rejection rollback — resets reviews + chapters + project phase node. (~637 tok)
...
- `service.py` — Role service for extensions module. (~3989 tok)
...
- `routers.py` — FastAPI routers for workflow definitions. (~7941 tok)
- `schemas.py` — Pydantic: WorkflowDefinitionCreate (~1924 tok)
- `service.py` — ── DAG Validation ── (~3027 tok)
- `system_nodes.py` — Built-in system node types: start, end. (~1691 tok)
...
- `dependency_graph.py` — Derive chapter dependency graph from a template section tree. (~610 tok)
- `generation_strategy.py` — AI generation strategy selector — batch vs per-chapter. (~267 tok)
- `state_machine.py` — Canonical chapter status state machine (single source of truth). (~506 tok)
- `writer_assignment.py` — Writer assignment with workload-aware load balancing. (~126 tok)
...
- `service.py` — ScheduledTaskService: run_once, dispatch_task (~5640 tok)
...
- `index.ts` — Extract readable text from a Yjs document for diff/summary purposes. (~1533 tok)
...
- `client.py` — DeerFlowClient — Embedded Python client for DeerFlow agent system. (~19170 tok)
...
- `view_image_middleware.py` — Middleware for injecting image details into conversation before LLM call. (~3894 tok)

## backend/packages/harness/deerflow/community/e2b_sandbox/

- `e2b_sandbox_provider.py` — ``E2BSandboxProvider`` — DeerFlow :class:`SandboxProvider` for e2b cloud. (~14672 tok)
...
- `app_config.py` — Pydantic: CircuitBreakerConfig (~10425 tok)
- `database_config.py` — Unified database backend configuration. (~1240 tok)
...
- `reload_boundary.py` — Single source of truth for the config hot-reload boundary. (~2208 tok)
...
- `gateway.py` — Gateway-side plumbing for app-scoped extension contributions. (~7360 tok)
...
- `client.py` — MCP client using langchain-mcp-adapters. (~933 tok)
...
- `sql.py` — SQL repository for user-owned IM channel connections. (~4820 tok)

## backend/packages/harness/deerflow/persistence/models/

- `__init__.py` — ORM model registration entry point. (~486 tok)
...
- `worker.py` — Background agent execution. (~22189 tok)
...
- `callbacks.py` — Lightweight callback registry for cross-layer communication. (~630 tok)
...
- `file_conversion.py` — File conversion utilities. (~3743 tok)
...
- `test_data_deny_e2e.py` — deny_data_scopes 必须到达 knowledge 真实列表查询（engine 组合之外，走 with_data_scope 全链）。 (~466 tok)
...
- `test_permissions_me_endpoint.py` — /api/permissions/me 端点 HTTP 测试（修复前 0 覆盖）。 (~669 tok)
- `test_personal_outputs.py` — Tests for personal-outputs endpoint and star/share metadata. (~1128 tok)
- `test_phase_review.py` — Tests for PhaseReview model, schemas, and DAG validation. (~1148 tok)
- `test_policy_crud.py` — Tests for Policy model and engine integration. (~741 tok)
- `test_policy_deny_endpoint.py` — deny_permissions 策略 → 真实 HTTP 端点 403（Y 被拒 / Z 放行 / 超管豁免 / 空条件全员）。 (~379 tok)
- `test_policy_enforcement.py` — Composition tests: the deny pipeline end-to-end at the engine layer (DB mocked). (~2250 tok)
- `test_project_data_access.py` — Project data-access scope tests (Task L1). (~1802 tok)
- `test_project_idor_http.py` — 项目 IDOR 端点 HTTP 级闭合：非成员 403 / 成员 200 / 超管 200。 (~546 tok)
- `test_project_idor.py` — Task 12: project IDOR closure — require_project_member dependency tests. (~1432 tok)
...
- `config.yaml` (~2914 tok)
- `cutover.md` — EAI-Flow 数据安全割接手册（旧部署 → 新方案） (~1874 tok)
- `deploy.conf.example` — EAI-Flow 部署配置（唯一需要手写的文件） (~175 tok)
- `deploy.sh` — ============================================================================= (~2239 tok)
- `docker-compose.extensions.yaml` — ============================================================================= (~1885 tok)
- `docker-compose.ragflow.yaml` — ============================================================================= (~1382 tok)
- `docker-compose.temporal.yaml` — ============================================================================= (~212 tok)
- `docker-compose.yaml` — ============================================================================= (~1419 tok)
- `extensions_config.json` (~1046 tok)
- `MANUAL-DEPLOY.md` — EAI-Flow 全新部署手册（离线生产环境 · 完整操作步骤） (~3135 tok)
- `MANUAL-UPGRADE.md` — EAI-Flow 更新手册（离线生产环境 · 完整操作步骤） (~3595 tok)
- `ragflow-fixed.Dockerfile` — EAI-CUSTOM: RAGFlow v0.25.3 离线修复镜像 (~255 tok)
- `README.md` — Project documentation (~1066 tok)
- `upgrade.sh` — upgrade.sh — 服务器端增量升级（配合 scripts/offline-export.sh --delta 产出的 delta 包） (~1182 tok)

## deploy/offline/brand-assets/

- `README.md` — Project documentation (~199 tok)
...
- `docker-compose.extensions.yaml` — DeerFlow Extensions Services (~512 tok)
- `docker-compose.ragflow.yaml` — RAGFlow Service Stack (~1412 tok)
- `docker-compose.temporal.yaml` — docker/docker-compose.temporal.yaml (~224 tok)
...
- `OFFLINE_DEPLOYMENT_GUIDE.md` — EAI-Flow 内网离线部署操作手册 (~7169 tok)
- `prototype-contract-price-dashboard-light.html` — 合同价格分析 — 浅色 (~5313 tok)
- `prototype-contract-price-dashboard.html` — 合同价格分析 — 总览原型 (~6500 tok)
...
- `2026-06-02-dashboard-ui-uplift.md` — Dashboard UI Uplift Implementation Plan (~5183 tok)
- `2026-06-02-template-management-redesign.md` — Template Management Redesign — Implementation Plan (~19440 tok)
- `2026-06-03-layout-template-system.md` — Layout Template System Implementation Plan (~17806 tok)
- `2026-06-03-project-doc-tab-unification.md` — Project Doc Tab Unification — Implementation Plan (~5259 tok)
...
- `2026-06-17-data-source-backend-mcp-bridge.md` — 数据源后端 + MCP 桥 Implementation Plan (~13429 tok)
- `2026-06-18-data-source-agent-awareness-tier1.md` — 数据源 Tier 1:Agent 感知 Implementation Plan (~2930 tok)
...
- `2026-07-26-docmgr-ai-panel-redesign.md` — 文档空间右侧 AI 助手重新定位 — 实施计划 (~6539 tok)
- `2026-07-27-agent-registry.md` — Agent 注册表（数字员工看板）Implementation Plan (~20052 tok)
- `2026-07-29-offline-deploy-simplification.md` — 离线部署简化与增量升级 — Implementation Plan (~8210 tok)
...
- `2026-08-02-auth-unify.md` — EAI 统一认证门面（工号+密码 / 邮箱+验证码）Implementation Plan (~10596 tok)
...
- `2026-08-02-sso-integration.md` — SSO 集成（通用 OIDC 第三门面）Implementation Plan (~6472 tok)
- `2026-08-03-cpa-permissions-simplify.md` — 合同价格权限收敛 实施计划 (~1692 tok)
- `2026-08-03-kf-permissions-simplify.md` — 知识工厂权限简化 实施计划 (~3324 tok)
- `2026-08-03-role-permissions-tab.md` — 角色管理操作权限 Tab UI/UE 改进 + 插件市场下线 实施计划 (~5054 tok)
- `2026-08-04-data-access-control-unification.md` — 数据访问控制统一 + ABAC deny 实施计划(16 任务/8 阶段,TDD) (~2600 tok)
- `2026-08-04-data-access-control-unification.md` — 数据访问控制统一 + ABAC deny 原语 — Implementation Plan (~7716 tok)
- `2026-08-05-abac-p0-ui-completion.md` — ABAC-lite 范围补全（P0）实施计划 (~2039 tok)
- `2026-08-05-fire-protection-extract-staged.md` — fire-protection-extract 分阶段重构 实施计划 (~12398 tok)
...
- `2026-08-14-bid-quote-filter-multicompetitor.md` — 投标报价分析 过滤条件 + 多家友商 实现计划 (~14446 tok)
...
- `2026-08-05-role-permission-deep-audit-report.md` — 角色管理 · 操作权限 + 数据访问权限 深度审计报告 (~1729 tok)
...
- `2026-05-21-document-space-enhancement-design.md` — Document Space Enhancement Design (~1653 tok)
...
- `2026-06-02-dashboard-ui-uplift-design.md` — Dashboard UI Uplift Design (~950 tok)
- `2026-06-02-template-management-redesign.md` — 模板管理重构设计 (~1899 tok)
- `2026-06-03-layout-template-system-design.md` — Layout Template System Design (~2503 tok)
- `2026-06-03-project-doc-tab-unification-design.md` — Design: Unify Project Doc Tab with Document Space (~1719 tok)
- `2026-06-03-workflow-collaboration-test-plan.md` — 工作流协作体系 — 分角色功能测试计划 (~1637 tok)
- `2026-06-03-workflow-collaboration-test-report.md` — 工作流协作体系 — 分角色功能测试报告 (~2206 tok)
- `2026-06-04-project-overview-tab-redesign.md` — 项目概览 Tab 重设计 + Tab 合并 (~1067 tok)
- `2026-06-09-sandbox-outputs-sync-design.md` — 沙箱输出文件自动同步到文档空间设计规格 (~1032 tok)
- `2026-06-10-traffic-review-platform-design.md` — 面向交通工程设计审查的多智能体协同审核平台研究与应用 (~2200 tok)
...
- `2026-06-17-data-source-backend-mcp-bridge-design.md` — 数据源后端 + MCP 桥 设计文档 (~2168 tok)
- `2026-06-18-data-source-agent-awareness-tier1-design.md` — 数据源 Tier 1:Agent 感知 实现规格 (~1088 tok)
- `2026-06-18-data-source-agent-awareness-tier1-draft.md` — 数据源 → Agent 感知(Tier 1)产品 spec 草稿 (~644 tok)
- `2026-06-18-data-source-dataset-ui-design.md` — 数据集标注 UI 设计规格 (~538 tok)
- `2026-06-18-data-source-datasets-design.md` — 数据源数据集层(DataSourceDataset)Phase 1 实现规格 (~1053 tok)
- `2026-06-18-data-source-rich-introspection-design.md` — 数据源富内省(列画像)设计规格 (~359 tok)
- `2026-06-18-plugin-backend-metadata-layer-design.md` — 插件 tab 后端(元数据层)设计文档 (~1498 tok)
- `2026-06-18-plugin-data-connector-to-datasource-design.md` — data_connector 插件 → 数据源模板 实现规格 (~854 tok)
...
- `2026-07-23-docmgr-agent-editor-design.md` — 文档空间 — AI Agent 编辑器协作设计 (~3164 tok)
- `2026-07-25-docmgr-blocknote-ai-unification.md` — 文档空间 AI 助手重构 — BlockNote 统一方案 (~843 tok)
- `2026-07-26-docmgr-ai-panel-redesign.md` — 文档空间 — 右侧 AI 助手重新定位设计 (~1875 tok)
...
- `2026-08-02-auth-unify-design.md` — EAI 统一认证门面设计文档 (~2562 tok)
- `2026-08-02-docmgr-blocknote-editor-review-design.md` — 文档空间「我的文档」BlockNote 编辑器 — 代码 Review 与功能补全 (~1006 tok)
- `2026-08-02-role-management-manual-test-design.md` — 角色管理全面页面测试方案（人工） (~3619 tok)
- `2026-08-02-role-page-visibility-design.md` — 角色管理 · 子页面可见性控制设计 (~1128 tok)
- `2026-08-02-role-page-visibility-design.md` — 角色管理 · 子页面可见性控制设计 (~1061 tok)
- `2026-08-02-sso-integration-design.md` — EAI 统一认证门面 · SSO 单点登录集成设计 (~2886 tok)
- `2026-08-02-writing-project-single-state.md` — 写作项目管理模块 · 单一状态集设计（ADR） (~3021 tok)
- `2026-08-02-writing-project-single-state.md` — 写作项目单一状态集 ADR（项目{draft,in_review,approved}+归档轴；章节{pending,draft,reviewing,approved}；派生stage删current_stage；DB CHECK兜底；迁移方案） (~6000 tok)
- `2026-08-03-cpa-permissions-simplify-design.md` — 合同价格分析 · 权限收敛设计 (~680 tok)
- `2026-08-03-kf-permissions-simplify-design.md` — 知识工厂 · 权限划分简化设计 (~1119 tok)
- `2026-08-03-role-permissions-tab-ui-design.md` — 角色管理 · 操作权限 Tab UI/UE 改进 + 插件市场下线 (~1287 tok)
- `2026-08-04-abac-deny-primitive-design.md` — 数据访问控制统一 + ABAC deny 原语设计（scope 引擎主轴） (~3503 tok)
- `2026-08-05-fire-protection-extract-staged-design.md` — fire-protection-extract 技能分阶段重构设计 (~1776 tok)
- `2026-08-05-rbac-abac-architecture-assessment.md` — 角色管理权限架构 · ABAC 定性 + 完备性评估报告 (~1132 tok)
...
- `config.yaml` — Configuration for the DeerFlow application (~14189 tok)
...
- `brand.ts` — EAI-CUSTOM: 按客户品牌化（构建期注入）。 (~111 tok)
...
- `page.tsx` — LoginPage — renders form (~2992 tok)

## frontend/src/app/(auth)/setup/

- `page.tsx` — SetupPage — renders form (~2762 tok)

## frontend/src/app/[lang]/docs/

- `layout.tsx` — i18n (~328 tok)
...
- `page.tsx` — REPORT_TYPE_FILTERS (~3892 tok)

## frontend/src/app/admin/templates/[templateId]/

- `page.tsx` — EditTemplatePage (~90 tok)

## frontend/src/app/admin/templates/components/

- `ApprovalDialog.tsx` — ApprovalDialog (~849 tok)
- `ApprovalHistoryPanel.tsx` — ACTION_CONFIG (~543 tok)
- `SubmitApprovalDialog.tsx` — SubmitApprovalDialog (~551 tok)
- `TemplateEditorPage.tsx` — TemplateEditorPage (~3528 tok)

## frontend/src/app/admin/templates/new/

- `page.tsx` — NewTemplatePage (~48 tok)

## frontend/src/app/admin/users/

- `page.tsx` — Collect every department id in the tree (used to expand the tree on open). (~13263 tok)
...
- `route.ts` — Next.js API route: GET, DELETE (~304 tok)
...
## frontend/src/app/sales-personnel/

- `layout.tsx` — navItems (~649 tok)
- `page.tsx` — SalesPersonnelDashboardPage (~50 tok)

## frontend/src/app/sales-personnel/query/

- `page.tsx` — SalesPersonnelQueryPage (~46 tok)
...
- `page.tsx` — AgentChatPage (~4522 tok)

## frontend/src/app/workspace/agents/new/

- `page.tsx` — NAME_RE (~4038 tok)

## frontend/src/app/workspace/chats/

- `page.tsx` — ChatsPage (~1650 tok)

## frontend/src/app/workspace/chats/[thread_id]/

- `page.tsx` — WorkspaceChatPage (~39 tok)
- `providers.tsx` — ChatProviders (~176 tok)
...
- `App.tsx` — LandingNew (~4750 tok)
- `index.css` — Styles: 2 rules (~374 tok)

## frontend/src/components/landing/

- `footer.tsx` — EAI-CUSTOM: 按客户品牌化（构建期注入，见 brand.ts） (~362 tok)

## frontend/src/components/ui/

- `admin-select.tsx` — AdminSelect (~1094 tok)
- `calendar.tsx` — Calendar (~2226 tok)
- `magic-bento.css` — Styles: 28 rules, 19 vars (~1250 tok)
- `sonner.tsx` — Toaster (~317 tok)

## frontend/src/components/workspace/

- `context-usage-badge.tsx` — ContextUsageBadge (~409 tok)
- `context-usage-format.ts` — Format a context-usage percentage for display. (~197 tok)
- `input-box-helpers.ts` — Exports MAX_SKILL_SUGGESTIONS, MAX_GOAL_OBJECTIVE_CHARS, isGoalObjectiveTooLong, GOAL_OBJECTIVE_COUN (~2278 tok)
- `input-box.tsx` — Whether to render the input in welcome layout (vertically centered, (~27186 tok)
- `recent-chat-list.tsx` — RecentChatList (~3901 tok)
...
- `agent-gallery.tsx` — AgentGallery (~664 tok)

## frontend/src/components/workspace/artifacts/

- `artifact-file-detail.tsx` — WRITE_FILE_PREVIEW_REFRESH_INTERVAL_MS (~5593 tok)
- `save-artifact-to-doc-button.tsx` — checkDocExists (~1482 tok)

## frontend/src/components/workspace/channels/

- `workspace-channels-list.tsx` — getProviderUnavailableReason (~1996 tok)

## frontend/src/components/workspace/chats/

- `chat-box.tsx` — Auto-sync thread files to document space when the AI finishes responding. (~2051 tok)
- `chat-page.tsx` — ChatPage (~5161 tok)

## frontend/src/components/workspace/citations/

- `artifact-link.tsx` — Link renderer for artifact markdown: citation: prefix → CitationLink, otherwise underlined text. (~331 tok)

## frontend/src/components/workspace/messages/

- `markdown-content.tsx` — Renders markdown content. (~1293 tok)
- `markdown-link.tsx` — Schemes we are willing to render as a navigable ``<a href=...>``. (~1361 tok)
- `message-group.tsx` — MessageGroup (~6576 tok)
- `message-list-item.tsx` — Custom image component that handles artifact URLs (~7173 tok)
...
- `api.ts` — Raw backend `detail` string when the failure came from a backend (~1220 tok)

## frontend/src/core/api/

- `api-client.ts` — SDK ``onRequest`` hook that mints the ``X-CSRF-Token`` header from the (~3004 tok)
- `stream-mode.ts` — Stream modes required for chat runs — used by EAI hooks.ts. (~660 tok)

## frontend/src/core/artifacts/

- `utils.ts` — Exports urlOfArtifact, extractArtifactsFromThread, buildWriteFileArtifactURL, resolveArtifactURL, re (~770 tok)
...
- `index.ts` — Exports getBackendBaseURL, getLangGraphBaseURL (~304 tok)
...
- `utils.ts` — Exports MessageGroup, getMessageGroups, getBranchableAssistantGroupIds, EditableTurn + 6 more (~7504 tok)
...
- `local.ts` — Best-effort localStorage facade. (~1164 tok)
...
- `utils.ts` — Exports THREAD_PINNED_METADATA_KEY, ChannelThreadSource, pathOfThread, textOfMessage + 2 more (~817 tok)

## frontend/src/core/uploads/

- `api.ts` — API functions for file uploads (~808 tok)
...
- `categories.ts` — accent 调色板（通用分类占用后，业务域按首次出现顺序轮转） (~1104 tok)
- `icons.ts` — Maps DB-stored icon_name strings to Lucide React components. (~278 tok)
...
- `QuickPanel.tsx` — entries (~1292 tok)
...
- `ai-deletion.ts` — AI 标记删除文字: 红色删除线 (~200 tok)
- `ai-deletion.ts` — AI 标记删除文字 — 红色删除线 + 变灰。 (~179 tok)
- `ai-format.ts` — AI 格式调整: 蓝色下划线 (~200 tok)
...
- `lawCategories.ts` — Exports LawType, LawCategory, LAW_CATEGORIES, LAW_TYPE_OPTIONS + 5 more (~850 tok)
...
- `api.ts` — Exports outputApi (~1727 tok)
- `OutputManager.tsx` — NAV_ITEMS — renders table (~3644 tok)
- `transforms.ts` — Exports transformTemplate (~334 tok)
- `types.ts` — Exports OutputFormat, WatermarkType, GenerateSource, LayoutTemplate + 13 more (~770 tok)
...
- `PluginMarketplace.tsx` — NAV_ITEMS — renders table (~5074 tok)
...
- `pageVisibility.ts` — 收集所有 registry module 的页面 id。 (~427 tok)
- `policyConverters.ts` — UI 条件数组 → 引擎 dict（空数组 → 空 dict，引擎视为无条件=全量；in/not_in 值按逗号拆成列表） (~1324 tok)
...
- `table.tsx` — Lightweight table primitives(raw HTML)—— sales-personnel 模块用。 (~458 tok)
...
- `index.ts` — EAI-CUSTOM: module nav visibility — list of nav IDs (e.g. "nav:knowledge") (~3008 tok)
...
- `PhaseProgressBar.tsx` — A compact multi-phase progress bar for v2 workflows. (~1361 tok)

## frontend/src/extensions/workflow/edges/

- `AnimatedFlowEdge.tsx` — EDGE_STYLES (~290 tok)
...
- `ProgressReviewNode.tsx` — STATUS_CONFIG (~1061 tok)
...
- `AIGenerateConfigPanel.tsx` — AIGenerateConfigPanel (~735 tok)
- `ConditionConfigPanel.tsx` — EXPR_PRESETS (~759 tok)
- `ManualEditConfigPanel.tsx` — ManualEditConfigPanel (~565 tok)
- `MergeConfigPanel.tsx` — MergeConfigPanel (~530 tok)
- `NodePalette.tsx` — NODE_TYPES (~1118 tok)
- `NotificationsConfigPanel.tsx` — TRIGGER_OPTIONS (~1045 tok)
- `NotifyConfigPanel.tsx` — NotifyConfigPanel (~500 tok)
- `PhaseConfigPanel.tsx` — PRESET_ROLES (~2019 tok)
- `ReviewConfigPanel.tsx` — MODES (~951 tok)
- `SubflowConfigPanel.tsx` — PRESET_ROLES (~2072 tok)
- `SubWorkflowConfigPanel.tsx` — SubWorkflowConfigPanel (~1050 tok)
- `TaskConfigPanel.tsx` — REVIEW_MODES (~2688 tok)

## frontend/src/extensions/workflow/templates/

- `four-phase.ts` — Exports FOUR_PHASE_TEMPLATE (~621 tok)
- `migration.ts` — V1 flat graph → v2 unified graph migration, plus auto-detect. (~1000 tok)
...
- `globals.css` — Styles: 66 rules, 159 vars (~10086 tok)
...
- `message-merge.test.ts` — Declares human (~1803 tok)
- `thread-history.test.ts` — --------------------------------------------------------------------------- (~2460 tok)
- `utils.test.ts` — Declares message (~895 tok)
...
- `user-api.test.ts` — Declares fetchMock (~309 tok)
...
- `page-visibility.test.ts` — Declares mods (~1132 tok)
- `policy-converters.test.ts` — EAI-CUSTOM: 策略条件/授权 shape 转换器单测（UI 数组 ⇄ 引擎 dict） (~1110 tok)
...
- `Dockerfile` — Docker container definition (~184 tok)
- `README.md` — Project documentation (~1044 tok)
...
- `ocr_engine.py` — Dual-path contract table extraction engine. (~4872 tok)
- `requirements.txt` — Python dependencies (~56 tok)
- `server.py` — eai-flow-ocr — FastAPI service wrapping OcrEngine. (~713 tok)

## scripts/

- `check_import_consistency.py` — Check import consistency across the backend. (~1025 tok)
...
- `generate-config.sh` — generate-config.sh — 读 deploy.conf（唯一可信配置源），生成 config.yaml / .env / extensions_config.json (~1759 tok)
- `offline-export.sh` — offline-export.sh - Export DeerFlow as a self-contained offline deployment package (~9088 tok)
- `serve.sh` — serve.sh — Unified DeerFlow service launcher (~3544 tok)
- `test_kanban.py` — ", handle_api) (~2873 tok)
- `wait-for-port.sh` — wait-for-port.sh - Wait for a TCP port to become available (~480 tok)

## scripts/tests/

- `test_delta_export.sh` — Self-check for the --delta diff logic (Task 3.2). (~339 tok)
- `test_generate_config.sh` — Self-check for generate-config.sh (Ponytail: one small runnable check, no framework). (~651 tok)
...
- `calc_params_guide.md` — 煤炭 EIA 计算脚本参数指南 (~1573 tok)
- `compliance_checklist.md` — 煤炭建设项目环境影响评价报告 合规性审查清单 (~751 tok)
- `content_guidelines.md` — 煤炭采选项目环境影响报告书编写内容规范 (~2380 tok)
- `report_structure.md` — 煤炭矿区总体规划环境影响报告书 — 章节结构模板 (~3400 tok)
- `sample_entities.md` — 样例报告实体黑名单 (~585 tok)
- `terminology.md` — 煤炭开采项目环境影响评价术语词典 (~1431 tok)

## skills/custom/coal-eia-report/references/chapter_examples/

- `sample_air_quality.md` — 大气环境影响章节示例 (Methodology Reference) (~582 tok)
- `sample_ecology.md` — 生态环境影响章节示例 (Methodology Reference) (~694 tok)
- `sample_subsidence.md` — 沉陷预测章节示例 (Methodology Reference) (~587 tok)
- `sample_water_quality.md` — 水环境影响章节示例 (Methodology Reference) (~629 tok)

## skills/custom/coal-eia-report/scripts/calc/

- `calc_air_screen.py` — calc_plume_rise, calc_sigma, gaussian_ground_conc, calc_air_screen (~1715 tok)
- `calc_capacity.py` — calc_air_capacity, calc_water_capacity, calc_capacity, main (~1753 tok)
...
- `SKILL.md` — 煤矿工程报告合规审查 Skill — 安全规程/技术指标/章节完整性/术语规范 (~1600 tok)
- `SKILL.md` — 煤矿工程报告合规审查 (~399 tok)
...
- `compliance_checker.py` — ComplianceChecker: load_report, check_fire_hazard_classification, check_fire_resistance_rating, chec (~3017 tok)

## skills/custom/geological-report/

- `SKILL.md` — NOTE: allowed-tools removed 2026-06-18. Declaring allowed-tools on ANY enabled skill (~1656 tok)

## skills/custom/kf-extract-template/
...
## skills/public/contract-price-analysis/
...
- `__init__.py` (~0 tok)
- `cli.py` — End-to-end pipeline (v2: MinIO + eai-flow-ocr). (~12911 tok)
...
- `document_parser.py` — Parse a contract file via the eai-flow-ocr HTTP service -> TableExtract list. (~1218 tok)
- `document_scanner.py` — Scan the MinIO bucket for contract files; detect changed via SHA-256. (~784 tok)
- `excel_generator.py` — 6-sheet Excel report with charts (xlsxwriter). (~1998 tok)
- `models.py` — SQLAlchemy ORM for cpa_ tables (v2: MinIO-backed documents). (~2101 tok)
- `project_fields.py` — Extract project-level fields (name, location) from OCR'd first-page text. (~1843 tok)
- `stats.py` — Aggregate statistics over a group of unit prices. (~528 tok)
- `table_classifier.py` — Classify extracted tables and map column roles. (~4680 tok)

## skills/public/contract-price-analysis/scripts/clustering/

- `__init__.py` — Clustering subpackage: vectorization + DBSCAN engine. (~24 tok)
- `engine.py` — DBSCAN clustering (numpy-only, no scikit-learn). (~924 tok)
- `vectorizer.py` — Feature vectorizer for goods-name clustering. (~1407 tok)

## skills/public/contract-price-analysis/tests/

- `test_cli.py` — v2 pipeline tests (MinIO + OCR mocked — no live services needed). (~1861 tok)
...
- `test_table_classifier.py` — bbox-x column alignment tests (the ② root fix, hybrid form). (~1070 tok)
- `test_vectorizer.py` — Tests for the type-blocking vectorizer. (~648 tok)

## skills/public/fire-protection-extract/

- `SKILL.md` — 适用条件（路由确认） (~2059 tok)

## skills/public/fire-protection-extract/contracts/初步设计/

- `仓库项目.json` (~2114 tok)

## skills/public/fire-protection-extract/contracts/基础设计/

- `基地项目.json` (~2275 tok)
- `基地综合大队消防站.json` (~1824 tok)

## skills/public/fire-protection-extract/references/

- `extractor_rules.md` — 抽取与溯源规则 (~821 tok)

## skills/public/fire-protection-extract/references/stage-outlines/

- `初步设计.json` (~983 tok)
- `基础设计.json` (~1364 tok)

## skills/public/fire-protection-extract/scripts/

- `contract_store.py` — Contract library: persist successful mapping contracts and find the best match for a new document. (~2642 tok)
- `detect_stage.py` — Detect design stage (初步设计/基础设计) from a parsed structure. (~368 tok)
- `extract.py` — 按阶段大纲 + 项目映射 逐字摘抄组装消防专篇 Markdown。 (~1390 tok)
- `grounding_check.py` — 逐字溯源校验 + 锚可达性 + 覆盖检查（两层：大纲+映射）。 (~1777 tok)
- `migrate_contracts.py` — 一次性迁移：旧契约 → 阶段子目录 + 新格式（两层：大纲+映射）。 (~1418 tok)
- `run.sh` — 消防设计专篇 一键流水线：解析 → 阶段检测 → 大纲 → 契约 → 抽取 → 溯源校验。 (~1483 tok)

## skills/public/fire-protection-extract/tests/

- `test_contract_store_stage.py` — setup_function, teardown_function, test_save_and_find_by_stage, test_find_tie_breaks_to_newest_saved (~1041 tok)
- `test_contract_store.py` — test_fingerprint_normal, test_fingerprint_empty, test_jaccard_both_empty, test_jaccard_one_empty (~1577 tok)
- `test_extract.py` — test_extract_verbatim_para_and_table, test_extract_conflict_uses_authoritative_not_wrong_source, tes (~538 tok)
- `test_grounding.py` — test_all_blocks_grounded, test_missing_anchor_reported, test_drift_detected, test_conflict_assertion (~954 tok)
- `test_integration.py` — End-to-end on the real sample pair. Skips unless the sample docx is present (~1092 tok)
- `test_migrate_contracts.py` — test_empty_anchor_returns_none, test_convert_old_para_anchor_to_index, test_convert_old_range_from_t (~607 tok)
- `test_routing.py` — test_extract_registered_in_extensions_config, test_v2_has_spec_exclusion, test_extract_has_spec_asse (~1662 tok)
- `test_staged_pipeline.py` — test_outline_files_exist, test_outline_structure_valid, test_preliminary_outline_titles, test_basic_ (~2747 tok)
- `verify_samples.sh` — 样例集成验证：跑通两个阶段，检查 章节=样例、grounding≥0.85、无[⚠未找到]。 (~677 tok)
