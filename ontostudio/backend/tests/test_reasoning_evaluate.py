...
from app.doc_graph.reasoning import evaluate as evaluate_mod
from app.doc_graph.reasoning import rule_registry
from app.doc_graph.reasoning.evaluate import evaluate_rules
from app.doc_graph.reasoning.facade import RuleFacade, RuleSyntaxError
from app.doc_graph.reasoning.rule_registry import RuleModel
...
def test_mcp_evaluate_rules_success_and_no_rules_dir_passthrough(monkeypatch):
    ...
    from app.doc_graph import mcp as mcp_mod
    ...
    from app.doc_graph.reasoning import evaluate as eval_mod
...
def _resolve_url() -> str | None:
    ...
    if url:
        return url
    try:
        from app.config import get_extensions_config
