...
from app.ontology.connectors import ConnectorError, OntologyConnectors
from app.ontology.schemas import AccessConfig
from app.sqlguard import assert_readonly_select
...
def test_security_single_source_is_data_source_guard():
    """D9(迁出独立后): assert_readonly_select import 自本服务单一真源 app.sqlguard（同一函数对象，非二次复制）。"""
    import app.ontology.connectors as c
