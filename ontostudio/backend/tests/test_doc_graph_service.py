...
from app.doc_graph.resolver import REVIEW_THRESHOLD
from app.doc_graph.service import MergeConflict, ResourceNotFound, score_candidates
...
def test_error_mapping_three_states():
    ...
    from app.doc_graph.routers import _resolution_http_error
...
def test_uuid_guard_malformed_is_404():
    ...
    from app.doc_graph.routers import _uuid_or_404
