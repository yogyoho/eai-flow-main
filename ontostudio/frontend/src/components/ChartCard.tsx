...
/**
 * 复制自 frontend/src/extensions/bid-quote/components/ChartCard.tsx（S2 Task 1, EAI-CUSTOM）——
 * 独立 Vite 应用内复制件（非跨包引用）；仅 import 路径改本地，内容零改动。
 */

import type { ReactNode } from "react";

import { CARD, CARD_BORDER, INK, INK_3 } from "@/components/chartTheme";
