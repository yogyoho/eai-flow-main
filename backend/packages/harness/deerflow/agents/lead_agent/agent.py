...
def _build_middlewares(
    ...
    *,
    ...
    if subagent_enabled:
        ...
        max_total_subagents = cfg.get("max_total_subagents", getattr(getattr(resolved_app_config, "subagents", None), "max_total_per_run", DEFAULT_MAX_TOTAL_SUBAGENTS_PER_RUN))
