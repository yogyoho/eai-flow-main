...
def request_cancel_background_task(execution_id: str) -> None:
    ...
    """
    # EAI-CUSTOM (2026-08-30, bug-3021; ported upstream 42796d708 2026-08-31):
    # upstream now applies the identical fix — lock scope only fetches
    # references, cancel runs after release. See upstream comment below.
    future: Future[SubagentResult] | None = None
    with _background_tasks_lock:
