...
class ReviewAssignment(Base):
    ...
    project_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("report_projects.id"), nullable=False, index=True)
    ...
    reviewer_role: Mapped[str] = mapped_column(String(50), nullable=False, default="reviewer")
