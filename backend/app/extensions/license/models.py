...
class License(Base):
    ...
    jwt_jti: Mapped[str] = mapped_column(String(64), unique=True, nullable=False, comment="JWT unique ID")
    machine_id: Mapped[str] = mapped_column(String(64), nullable=False, comment="Bound machine ID")
    type: Mapped[str] = mapped_column(String(20), nullable=False, comment="permanent | trial | subscription")
