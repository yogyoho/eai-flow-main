...
async def _run_lifespan_with_upload_staging_cleanup():
    ...
    return cleanup_upload_staging_files, stop_channel_service


def test_lifespan_sweeps_upload_staging_files_on_startup():
    cleanup_upload_staging_files, stop_channel_service = asyncio.run(_run_lifespan_with_upload_staging_cleanup())
