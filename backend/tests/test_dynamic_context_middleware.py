...
import hashlib
import json  # EAI-CUSTOM: project-context tests
from pathlib import Path  # EAI-CUSTOM: project-context tests
from tempfile import TemporaryDirectory  # EAI-CUSTOM: project-context tests
...
# ---------------------------------------------------------------------------
# EAI-CUSTOM (upstream-sync 2026-08-26): project-context injection (bug-697)
# Reads project-context.json via runtime user_id + configurable thread_id fallback.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Date timezone formatting (upstream #5154) — fused after EAI project-context section
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
