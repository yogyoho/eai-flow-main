...
fixes = [
    ...
    ("            await workflow.execute_activity(\n                _notify_workflow_complete, project_id,", "            await workflow.execute_activity(\n                _notify_workflow_complete, args=[project_id],"),
    # notify_review_pending in v2
    ("            await workflow.execute_activity(\n                _notify_review_pending, node_id, project_id,", "            await workflow.execute_activity(\n                _notify_review_pending, args=[node_id, project_id],"),
    ...
    ("            await workflow.execute_activity(\n                _notify_phase_start, phase_id, project_id,", "            await workflow.execute_activity(\n                _notify_phase_start, args=[phase_id, project_id],"),
    # init_phase in v2
    (
