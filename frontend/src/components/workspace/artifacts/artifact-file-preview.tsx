...
// EAI-CUSTOM: thread-relative image rewrite for markdown previews (moved here
// from artifact-file-detail.tsx when upstream extracted the preview components
// into this file, upstream-sync 2026-08-31).
