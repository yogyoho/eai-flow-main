...
export default function ChatPage() {
  ...
  const affiliatedProjectId =
    !isNewThread && !isMock && threadMetadata.data
      ...
      : null;
  // EAI: block rendering on the loading overlay until history is ready (see
  // pageReady effects above) — placed after all hooks and the affiliation
  // lookup so neither side's data prep is skipped.
  if (!pageReady) {
