    ...
    <main className="h-full flex flex-col overflow-hidden max-w-[1200px] w-full mx-auto bg-background">
      <div className="shrink-0 border-b border-border bg-card px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          <Link href="/workflow-admin/new" className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-primary rounded-lg hover:bg-primary/90 transition-colors shadow-sm">
          ...
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              ...
              {!searchQuery && !reportTypeFilter && (
                <Link href="/workflow-admin/new" className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors font-medium text-sm shadow-sm">
                  <Plus className="w-4 h-4" />新建模板
                </Link>
              )}
            </div>
                ...
                <div key={t.id} className="rounded-xl border border-border bg-card hover:shadow-sm transition-all overflow-hidden">
                  ...
                  <div className="px-5 py-3 border-t border-border bg-muted/30 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <Link href={`/workflow-admin/${t.id}`} title="编辑模板" className="p-1.5 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-md transition-colors">
