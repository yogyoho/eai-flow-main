...
export const enUS: Translations = {
  ...
  settings: {
    ...
    wechat: {
      ...
      botDescription: "Bind the DeerFlow bot to a WeChat iLink account (admins only).",
      bound: "Bound",
      unbound: "Unbound",
      pending: "Pending",
      bind: "Bind bot",
      rebind: "Rebind bot",
      bindStarted: "Bot binding started. Scan the QR code in WeChat to complete it.",
      bindFailed: "Failed to start bot binding.",
      openQr: "Open QR code",
      shareQrTitle: "Share invite QR",
      shareQrDescription: "Refresh the invite QR code that new users scan to reach the bot.",
      refreshShareQr: "Refresh",
      shareQrFreshHint: "Each refresh replaces the previous invite QR code.",
    },
    channels: {
      title: "Channels",
      description:
