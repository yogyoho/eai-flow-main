...
export const enUS: Translations = {
  ...
  settings: {
    ...
    sections: {
      ...
      about: "About",
      basic: "Basic", // EAI-CUSTOM: basic settings tab label
    },
    ...
    basic: {
      ...
      retrieval: {
        title: "Retrieval",
        description: "Configure default, fast, embedding models and reranker.",
      ...
      contentGuard: {
        title: "Content guard",
        description: "Configure the content guard toggle and review model.",
        enable: "Enable content guard",
        enableHint: "Run safety checks on input content.",
        enableLLM: "Enable LLM-based guard",
        enableLLMHint: "Use an LLM for deeper content review.",
        model: "Review model",
        modelPlaceholder: "Select a review model",
      },
      language: {
        title: "Language",
      ...
      services: {
        title: "Service links",
        description: "Quick access to related services.",
        docCenter: "Documentation",
        docCenterDesc: "View product docs and usage guides.",
        neo4j: "Neo4j",
        neo4jDesc: "Graph database console.",
        apiDocs: "API docs",
        apiDocsDesc: "View backend API documentation.",
        minio: "MinIO",
        minioDesc: "Object storage console.",
        milvus: "Milvus",
        milvusDesc: "Vector database WebUI.",
        ragflow: "RAGFlow",
        ragflowDesc: "Knowledge base and retrieval-augmented platform.",
      },
      save: "Save",
    },
    memory: {
    ...
    wechat: {
      ...
      botStatusTitle: "ClawBot activation",
      botActive: "ClawBot is active and online.",
      botPending: "Scan to activate ClawBot",
      botScanHint:
        "Scan this QR with WeChat to activate the bot, then wait for confirmation.",
      botExpired: "The activation QR has expired.",
      botNeedsActivation: "ClawBot is not activated yet.",
      botRegenerate: "Regenerate QR",
      botRegenerating: "Regenerating…",
      botAskAdmin: "Ask an admin to regenerate the activation QR.",
      botQrLoginDisabled:
        "QR login is disabled. Ask an admin to configure channels.wechat.bot_token.",
    },
