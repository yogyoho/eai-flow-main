...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    basic: {
      ...
      contentGuard: {
        title: "内容安全",
        description: "输入输出内容安全审核，拦截违规内容。",
        enable: "启用内容安全审核",
        enableHint: "开启后会对用户输入和模型输出进行内容安全检测。",
        enableLLM: "启用 LLM 审核",
        enableLLMHint: "使用大模型进行更智能的内容安全审查。",
        model: "审核模型",
        modelPlaceholder: "选择审核模型...",
      },
      services: {
        title: "服务配置",
        description: "管理 EAIFlow 依赖的外部服务和内部模块。",
        docCenter: "文档中心",
        docCenterDesc: "管理上传的文档和知识库文件。",
        neo4j: "Neo4j 图数据库",
        neo4jDesc: "连接 Neo4j 图数据库，用于知识图谱存储和查询。",
        apiDocs: "API 文档中心",
        apiDocsDesc: "管理 API 文档和接口说明。",
        minio: "MinIO 对象存储",
        minioDesc: "管理 MinIO 对象存储服务，用于文件和数据存储。",
        milvus: "Milvus 向量数据库",
        milvusDesc: "管理 Milvus 向量数据库，用于向量检索。",
        ragflow: "RAGFlow 知识库",
        ragflowDesc: "管理 RAGFlow 知识库服务，用于文档解析和检索增强生成。",
      },
      save: "保存",
      saveSuccess: "设置已保存",
      saveFailed: "保存失败，请重试",
    ...
    channels: {
      title: "渠道",
      description: "连接即时通讯平台，在浏览器外向 EAIFlow 发送消息。",
      disabled: "当前服务器未启用渠道连接。请联系管理员开启。",
    },
    notification: {
      title: "通知",
      description: "EAIFlow 只会在窗口不活跃时发送完成通知，适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
      requestPermission: "请求通知权限",
      deniedHint: "通知权限已被拒绝。可在浏览器的网站设置中重新开启。",
      testButton: "发送测试通知",
      testTitle: "EAIFlow",
      testBody: "这是一条测试通知。",
    ...
    skills: {
      title: "技能",
      description: "管理自定义技能，扩展 EAIFlow 的能力。",
      createSkill: "新建技能",
      emptyTitle: "还没有技能",
      emptyDescription: "将你的 Agent Skill 文件夹放在 EAIFlow 根目录下的 `/skills/custom` 文件夹中。",
    ...
    wechat: {
      title: "微信",
      description: "绑定微信账号，通过微信与 EAIFlow 交互。",
      linkTitle: "关联账号",
      linkDescription: "获取绑定码，在微信中发送指令完成账号关联。",
      getCode: "获取绑定码",
      codeHint: "在微信中向 EAIFlow Bot 发送上方指令即可完成绑定。",
      linkFailed: "获取绑定码失败，请重试。",
      botTitle: "机器人绑定",
      botDescription: "管理员可将 EAIFlow Bot 绑定到微信公众号，接收用户消息。",
      bound: "已绑定",
      pending: "等待扫码",
      unbound: "未绑定",
      bind: "绑定",
      rebind: "重新绑定",
      bindStarted: "绑定流程已启动，请扫码完成绑定。",
      bindFailed: "绑定失败，请重试。",
      openQr: "打开二维码",
      shareQrTitle: "分享二维码",
      shareQrDescription: "生成公众号分享二维码，供用户扫码关注和对话。",
      refreshShareQr: "刷新二维码",
      shareQrFreshHint: "二维码有时效限制，过期后请刷新重新生成。",
    },
    tools: {
      title: "工具",
      description: "管理 MCP 工具和外部服务连接。",
  ...
  login: {
    ...
    rememberMeDescription:
      "下次打开 EAIFlow 时尽量保持当前会话，仅保存邮箱，不保存密码。",
    pleaseWait: "请稍候...",
    signIn: "登录",
    createAccount: "创建账号",
