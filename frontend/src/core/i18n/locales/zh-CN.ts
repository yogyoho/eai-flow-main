...
export const zhCN: Translations = {
  ...
  channels: {
    ...
    wechatQr: {
      ...
      saved: "Token 已安全保存",
      savedDescription: "EAIFlow 已在服务器保存 Token 并启动微信渠道。",
      bindTitle: "最后一步：绑定你的账号",
      bindDescription:
        "将下方指令发送给微信中的机器人，即可绑定到你的 EAIFlow 账号。",
      ...
      login: "扫码连接",
      manual: "使用 Token",
      description: "将微信连接到你的 EAIFlow 工作空间。",
      loading: "正在生成二维码…",
      imageTitle: "微信登录二维码",
  ...
  settings: {
    ...
    // EAI-CUSTOM: basic settings namespace (BasicSettings 页 — 上游 settings 无 `basic` 块)
    basic: {
      title: "基础设置",
      theme: {
        system: "跟随系统",
      ...
      retrieval: {
        title: "检索配置",
        description: "配置默认模型、快速模型、嵌入模型与重排器。",
        defaultModel: "默认模型",
        fastModel: "快速模型",
        embedModel: "嵌入模型",
        placeholder: "请选择模型",
      ...
      contentGuard: {
        title: "内容审查",
        description: "配置内容审查开关及审查模型。",
        enable: "启用内容审查",
        enableHint: "对输入内容进行安全审查。",
        enableLLM: "启用 LLM 审查",
        enableLLMHint: "使用大模型进行更深入的内容审查。",
        model: "审查模型",
        modelPlaceholder: "选择审查模型",
      },
      language: {
        title: "语言",
      ...
      services: {
        title: "服务链接",
        description: "快速访问相关服务。",
        docCenter: "文档中心",
        docCenterDesc: "查看产品文档与使用指南。",
        neo4j: "Neo4j",
        neo4jDesc: "图数据库控制台。",
        apiDocs: "API 文档",
        ...
        minioDesc: "对象存储控制台。",
        milvus: "Milvus",
        milvusDesc: "向量数据库 WebUI。",
        ragflow: "RAGFlow",
        ragflowDesc: "知识库与检索增强平台。",
      },
      save: "保存",
    },
    memory: {
  ...
  "mcpServers": {
    ...
    wechat: {
      ...
      botStatusTitle: "ClawBot 激活状态",
      botActive: "ClawBot 已激活，在线运行中。",
      botPending: "扫码激活 ClawBot",
      botScanHint: "使用微信扫描下方二维码以激活 Bot，扫码后等待确认即可。",
      botExpired: "激活二维码已过期。",
      botNeedsActivation: "ClawBot 尚未激活。",
      botRegenerate: "重新生成二维码",
      botRegenerating: "正在重新生成…",
      botAskAdmin: "请联系管理员重新生成激活二维码。",
      botQrLoginDisabled:
        "未启用扫码登录，请联系管理员配置 channels.wechat.bot_token。",
    },
