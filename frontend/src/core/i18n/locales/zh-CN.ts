...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    wechat: {
      ...
      linkFailed: "生成绑定码失败。",
      botTitle: "Bot 绑定",
      botDescription: "将 DeerFlow Bot 绑定到微信 iLink 账号（仅管理员）。",
      bound: "已绑定",
      unbound: "未绑定",
      pending: "待确认",
      bind: "绑定 Bot",
      rebind: "重新绑定",
      bindStarted: "已开始绑定 Bot，请在微信扫码完成。",
      bindFailed: "启动 Bot 绑定失败。",
      openQr: "打开二维码",
      shareQrTitle: "分享邀请二维码",
      shareQrDescription: "刷新邀请二维码，新用户扫码即可找到 Bot。",
      refreshShareQr: "刷新",
      shareQrFreshHint: "每次刷新都会替换上一次的邀请二维码。",
    },
    channels: {
      title: "渠道",
