...
export function transformTemplate(
  ...
  return {
    ...
    coverTemplate:
      (data.cover_template as LayoutTemplate["coverTemplate"]) ?? null,
    coverMaster: (data.cover_master as LayoutTemplate["coverMaster"]) ?? null,
    coverElements:
      (data.cover_elements as LayoutTemplate["coverElements"]) ?? null,
    tocSettings: (data.toc_settings as LayoutTemplate["tocSettings"]) ?? null,
    bodyStyles: data.body_styles as LayoutTemplate["bodyStyles"],
    headingStyles:
      (data.heading_styles as LayoutTemplate["headingStyles"]) ?? [],
    tableStyles: (data.table_styles as LayoutTemplate["tableStyles"]) ?? null,
    figureStyles:
      (data.figure_styles as LayoutTemplate["figureStyles"]) ?? null,
    headerFooter:
      (data.header_footer as LayoutTemplate["headerFooter"]) ?? null,
    referenceStyle: (data.reference_style as string) ?? "gb7714",
    appendixRules:
      (data.appendix_rules as LayoutTemplate["appendixRules"]) ?? null,
