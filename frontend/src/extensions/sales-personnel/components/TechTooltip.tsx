...
import { CARD, INK, INK_2 } from "@/extensions/sales-personnel/components/chartTheme";

// recharts 自定义 tooltip:DeepSeek 风白卡(克隆自 biz-pipeline/TechTooltip,无光晕无玻璃)。
