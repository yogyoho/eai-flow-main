...
function formatRunLabel(run: CspRun | null, runId: string | null): string {
...
function formatRunCompact(run: CspRun | null, runId: string | null): string {
...
export function ItemsView() {
  ...
  const toggleSelectAll = (pageItems: CspItem[]) => {
