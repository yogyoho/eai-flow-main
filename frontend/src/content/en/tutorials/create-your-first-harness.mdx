...
description: This tutorial shows you how to use the EAIFlow Harness programmatically — importing and using EAIFlow directly in your Python code rather than through the web interface.
---
...
This tutorial shows you how to use the EAIFlow Harness programmatically — importing and using EAIFlow directly in your Python code rather than through the web interface.

## Prerequisites

- Python 3.12+
- `uv` installed
- EAIFlow repository cloned
