...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes EAIFlow capable of real action, not just
  conversation.
</Callout>
...
EAIFlow supports three sandbox modes. Choose the one that fits your deployment:
