---
title: EAIFlow App
description: EAIFlow App is the reference implementation of what a production EAIFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
---
...
<Callout type="info" emoji="🚀">
  EAIFlow App is a complete Super Agent application built on top of EAIFlow
...
EAIFlow App is the reference implementation of what a production EAIFlow experience looks like. It assembles the Harness runtime, a web-based conversation workspace, an API gateway, and a reverse proxy into a single deployable system.
...
The EAIFlow App runs behind a single nginx reverse proxy:
...
| Agent runtime     | LangGraph, LangChain, EAIFlow Harness                               |
| Reverse proxy     | nginx                                                                |
